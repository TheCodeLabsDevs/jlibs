...
// https://github.com/gluons/Font-Awesome-Icon-Chars/blob/master/character-list/character-list.json
// jq -r '.solid[] | "\(.name): \(.unicode)"' character-list.json
public enum FontAwesomeType implements FontIconType {
	...
	private static final String FONT_FILE = "fonts/Font Awesome 6 Free-Solid-900.otf";
