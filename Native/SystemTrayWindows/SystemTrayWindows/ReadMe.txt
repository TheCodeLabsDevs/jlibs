========================================================================
    DYNAMIC LINK LIBRARY: SystemTrayWindows-Projektübersicht
========================================================================

Diese SystemTrayWindows-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre SystemTrayWindows-Anwendung besteht.

SystemTrayWindows.vcxproj
...
SystemTrayWindows.vcxproj.filters
