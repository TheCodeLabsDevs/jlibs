...
final class CoreMidiLibrary {
    ...
    static final MethodHandle h_MIDIInputPortCreate;
    static final MethodHandle h_MIDIOutputPortCreate;
    static final MethodHandle h_MIDIPortConnectSource;
    private static final MethodHandle h_MIDIPortDisconnectSource;
    private static final MethodHandle h_MIDIPortDispose;
    static final MethodHandle h_MIDISend;
